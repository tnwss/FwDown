...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'fwdown' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'fwdown' ),
		'repeat-y'  => __( 'Repeat Vertically', 'fwdown' ),
		'repeat'    => __( 'Repeat All', 'fwdown' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'fwdown' ),
		'top center'    => __( 'Top Center', 'fwdown' ),
		'top right'     => __( 'Top Right', 'fwdown' ),
		'center left'   => __( 'Middle Left', 'fwdown' ),
		'center center' => __( 'Middle Center', 'fwdown' ),
		'center right'  => __( 'Middle Right', 'fwdown' ),
		'bottom left'   => __( 'Bottom Left', 'fwdown' ),
		'bottom center' => __( 'Bottom Center', 'fwdown' ),
		'bottom right'  => __( 'Bottom Right', 'fwdown')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'fwdown' ),
		'fixed'  => __( 'Fixed in Place', 'fwdown')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'fwdown' ),
		'italic'      => __( 'Italic', 'fwdown' ),
		'bold'        => __( 'Bold', 'fwdown' ),
		'bold italic' => __( 'Bold Italic', 'fwdown' )
		);
 ...
 * @return   bool
 */
function of_sanitize_accordion() {
	
}

 add_filter( 'of_sanitize_accordion', 'of_sanitize_accordion' );

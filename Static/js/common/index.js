...
Page.prototype = {
  ...
  pageChange: function () {
    ...
    // 
    if (this.pageCounter == 7) {
      $('.wrapper').css('margin-top', '-490px');
      $('.wrapper-7').show();
      $('.main-header').css('background', 'url(/wp-content/themes/FwDown/Static/img/transition_5.jpeg)top');
    } else {
